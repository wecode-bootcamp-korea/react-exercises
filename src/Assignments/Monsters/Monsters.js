...
function Monsters() {
  ...
  const newMonsters = monsters.filter((monster)=> monster.name.toLowerCase().includes(userInput))
  return (
    <div className="monsters">
      <h1>컴포넌트 재사용 연습!</h1>
      <SearchBox handleChange={handleChange}/>
      <CardList monsters={monsters} newMonsters={newMonsters} userInput={userInput} />
