...
function Monsters() {
  ...
  const handleChange = ((event) => {
    ...
    filterKeyword (monsters);
  });

  function filterKeyword (monsters) {
    monsters.filter((val) => { if(val.name.toLowerCase().includes(userInput.toLowerCase())){return val;} }).map((elements) => {
